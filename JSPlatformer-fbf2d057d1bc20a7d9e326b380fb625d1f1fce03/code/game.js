...
/*function Reteleport(pos) {
  this.basePos = this.pos = pos.plus(new Vector(0.2, 0.1));
  this.size = new Vector(0.6, 0.6);
  // Make it go back and forth in a sine wave.
  this.wobble = Math.random() * Math.PI * 2;
}
Reteleport.prototype.type = "reteleport";*/
...
//reteleport.prototype.act = function(step, level) {
//  var newPos = this.pos.plus(this.speed.times(step));
//  if (!level.obstacleAt(newPos, this.size))
...
var wobbleSpeed = 8, wobbleDist = 4.0;
...
/*var maxStep = 0.05;
var wobbleSpeed = 11.75, wobbleDist = 0.1;

Reteleport.prototype.act = function(step) {
    this.wobble += step * wobbleSpeed;
    var wobblePos = Math.sin(this.wobble) * wobbleDist;
    this.pos = this.basePos.plus(new Vector(0, wobblePos));
}; */
...
Player.prototype.moveY = function(step, level, keys) {
  ...
  if (obstacle == "reteleport") {
      console.log ("ooooohhh no!");
      this.pos = new Vector (40,16);
    }
    //else if (obstacle == "reteleport") {
      //console.log ("Sucks!");
      //this.pos = new Vector (2,16);
    //};
